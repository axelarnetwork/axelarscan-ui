...
export const dlValueWithSpace = 'mt-1 flex flex-col space-y-2 text-sm leading-6 text-zinc-700 dark:text-zinc-300 sm:col-span-2 sm:mt-0' as const;
...
export const rewardsTableScroll = '-mx-4 overflow-x-auto sm:-mx-0 lg:overflow-x-visible' as const;
export const rewardsTable = 'min-w-full divide-y divide-zinc-200 dark:divide-zinc-700' as const;
export const rewardsTableHead = 'sticky top-0 z-10 bg-white dark:bg-zinc-900' as const;
export const rewardsTableHeadRow = 'text-sm font-semibold text-zinc-800 dark:text-zinc-200' as const;
...
export const rewardsThLast = 'whitespace-nowrap px-3 py-2.5 pl-3 pr-4 text-right sm:pr-3' as const;
export const rewardsTableBody = 'divide-y divide-zinc-100 bg-white dark:divide-zinc-800 dark:bg-zinc-900' as const;
export const rewardsRow = 'align-top text-xs text-zinc-400 dark:text-zinc-500' as const;
...
// Links
export const blueLink = 'font-semibold text-blue-600 dark:text-blue-500' as const;
export const numberXs = 'text-xs' as const;
export const chainFallbackText = 'text-zinc-900 dark:text-zinc-100' as const;
export const amountValue = 'text-xs font-semibold text-zinc-900 dark:text-zinc-100' as const;
