// Header
export const headerWrapper = 'flex flex-col gap-y-4 sm:flex-row sm:items-center sm:justify-between sm:gap-x-4 sm:gap-y-0' as const;
export const navLinks = 'flex items-center space-x-2' as const;
export const validatorsLink = 'text-base font-medium leading-6 text-blue-600 dark:text-blue-500' as const;
...
export const thLast = 'whitespace-nowrap py-3.5 pl-3 pr-4 text-left sm:pr-0' as const;
...
// Chain grid
export const chainGridBase = 'grid grid-cols-2 gap-x-2 gap-y-1 lg:grid-cols-3' as const;
...
export const chainName = 'whitespace-nowrap text-xs text-zinc-900 dark:text-zinc-100' as const;
export const notSupported = 'whitespace-nowrap text-xs font-medium text-zinc-400 dark:text-zinc-500' as const;
export const statsWrapper = 'flex items-center gap-x-4' as const;
export const statsInner = 'flex items-center gap-x-1' as const;
export const statsActive = 'text-xs font-medium text-zinc-900 dark:text-zinc-100' as const;
export const statsInactive = 'text-xs font-medium text-zinc-400 dark:text-zinc-500' as const;
