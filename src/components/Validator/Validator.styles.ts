// Info panel
export const infoPanel = 'overflow-hidden bg-zinc-50/75 shadow dark:bg-zinc-800/25 sm:rounded-lg' as const;
export const infoPanelHeader = 'px-4 py-6 sm:px-6' as const;
export const infoPanelTitle = 'text-base font-semibold leading-7 text-zinc-900 dark:text-zinc-100' as const;
export const infoPanelDescriptionWrapper = 'mt-1 flex flex-col' as const;
export const infoPanelDetails = 'linkify max-w-xl whitespace-pre-wrap break-words text-sm leading-6 text-zinc-400 dark:text-zinc-500' as const;
export const infoPanelWebsite = 'text-sm text-blue-600 dark:text-blue-500' as const;
export const infoPanelBorder = 'border-t border-zinc-200 dark:border-zinc-700' as const;
export const infoPanelDefinitionList = 'divide-y divide-zinc-100 dark:divide-zinc-800' as const;

// Definition list rows
export const dlRow = 'px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6' as const;
export const dlLabel = 'text-sm font-medium text-zinc-900 dark:text-zinc-100' as const;
export const dlValue = 'mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300 sm:col-span-2 sm:mt-0' as const;

// Links
export const blueLink = 'text-blue-600 dark:text-blue-500' as const;
export const delegatorLink = 'font-medium text-blue-600 dark:text-blue-500' as const;
...
export const delegationsTableScroll = '-mx-4 overflow-x-auto sm:-mx-0 lg:overflow-x-visible' as const;
export const delegationsTable = 'min-w-full divide-y divide-zinc-200 dark:divide-zinc-700' as const;
export const delegationsTableHead = 'sticky top-0 z-10 bg-white dark:bg-zinc-900' as const;
export const delegationsTableHeadRow = 'text-sm font-semibold text-zinc-800 dark:text-zinc-200' as const;
...
export const delegationsThLast = 'px-3 py-2.5 pl-3 pr-4 text-right sm:pr-3' as const;
export const delegationsTableBody = 'divide-y divide-zinc-100 bg-white dark:divide-zinc-800 dark:bg-zinc-900' as const;
export const delegationsRow = 'align-top text-xs text-zinc-400 dark:text-zinc-500' as const;
...
export const delegationsAmountWrapper = 'flex items-center justify-end' as const;
export const delegationsAmountValue = 'text-xs font-semibold text-zinc-900 dark:text-zinc-100' as const;
...
export const sectionHeader = 'flex items-center justify-between gap-x-4 pr-1' as const;
...
export const sectionTitle = 'text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100' as const;
export const sectionSubtitle = 'text-xs leading-5 text-zinc-400 dark:text-zinc-500' as const;
