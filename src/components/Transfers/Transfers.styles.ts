...
export const filterBackdrop = 'fixed inset-0 bg-zinc-50 bg-opacity-50 transition-opacity dark:bg-zinc-900 dark:bg-opacity-50' as const;
...
export const filterPanelPositioner = 'pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16' as const;
export const filterPanel = 'pointer-events-auto w-screen max-w-md' as const;
export const filterForm = 'flex h-full flex-col divide-y divide-zinc-200 bg-white shadow-xl' as const;
export const filterFormScrollArea = 'h-0 flex-1 overflow-y-auto' as const;
export const filterHeader = 'flex items-center justify-between bg-blue-600 p-4 sm:px-6' as const;
export const filterHeaderTitle = 'text-base font-semibold leading-6 text-white' as const;
export const filterCloseBtn = 'relative ml-3 text-blue-200 hover:text-white' as const;
export const filterAttributesList = 'flex flex-1 flex-col justify-between gap-y-6 px-4 py-6 sm:px-6' as const;
...
export const selectChevronWrapper = 'pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2' as const;
export const selectChevronIcon = 'text-zinc-400' as const;
export const selectMultiTag = 'my-1 mr-2 flex h-6 min-w-fit items-center rounded-xl bg-zinc-100 px-2.5 py-1 text-zinc-900' as const;

// ─── Filter Combobox Dropdown ──────────────────────────────────
export const comboboxDropdownWrapper = 'mt-2 gap-y-2' as const;
export const comboboxInput = 'w-full rounded-md border border-zinc-200 py-1.5 text-zinc-900 shadow-sm placeholder:text-zinc-400 focus:border-blue-600 focus:ring-0 sm:text-sm sm:leading-6' as const;
export const comboboxOptions = 'absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg sm:text-sm' as const;
export const comboboxOptionBase = 'relative cursor-default select-none py-2 pl-3 pr-9' as const;
...
export const optionCheckWrapper = 'absolute inset-y-0 right-0 flex items-center pr-4' as const;
...
// ─── Filter Text Input ─────────────────────────────────────────
export const textInput = 'w-full rounded-md border border-zinc-200 py-1.5 text-zinc-900 shadow-sm placeholder:text-zinc-400 focus:border-blue-600 focus:ring-0 sm:text-sm sm:leading-6' as const;

// ─── Filter Footer Buttons ─────────────────────────────────────
export const filterFooter = 'flex flex-shrink-0 justify-end p-4' as const;
export const resetBtn = 'rounded-md bg-white px-3 py-2 text-sm font-semibold text-zinc-900 shadow-sm ring-1 ring-inset ring-zinc-200 hover:bg-zinc-50' as const;
export const submitBtnBase = 'ml-4 inline-flex justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600' as const;
...
// ─── Deprecation Banner ────────────────────────────────────────
export const deprecationBanner = 'mb-4 flex items-center gap-x-2 rounded-lg border border-yellow-200 bg-yellow-50 p-3 text-yellow-800 dark:border-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-200' as const;
export const deprecationBannerText = 'text-sm' as const;

// ─── Transfers Layout ──────────────────────────────────────────
export const transfersContainer = 'sm:mt-8' as const;
export const transfersHeaderRow = 'flex items-center justify-between gap-x-4' as const;
export const transfersHeaderLeft = 'sm:flex-auto' as const;
export const transfersTitle = 'text-base font-semibold leading-6 text-zinc-900 dark:text-zinc-100' as const;
export const transfersSubtitle = 'mt-2 text-sm text-zinc-400 dark:text-zinc-500' as const;
...
export const thTxHash = 'whitespace-nowrap py-3.5 pl-4 pr-3 text-left sm:pl-0' as const;
export const thDefault = 'px-3 py-3.5 text-left' as const;
export const thCreatedAt = 'whitespace-nowrap py-3.5 pl-3 pr-4 text-right sm:pr-0' as const;
...
export const tdTxHashLink = 'font-semibold text-blue-600 dark:text-blue-500' as const;
export const tdDefault = 'px-3 py-4 text-left' as const;
export const tdCreatedAt = 'flex items-center justify-end py-4 pl-3 pr-4 text-right sm:pr-0' as const;

// ─── Method Column ─────────────────────────────────────────────
export const methodCol = 'flex flex-col gap-y-1.5' as const;
export const tagFitCapitalize = 'w-fit capitalize' as const;
export const assetBadge = 'flex h-6 w-fit items-center gap-x-1.5 rounded-xl bg-zinc-100 px-2.5 py-1 dark:bg-zinc-800' as const;
export const assetNumberText = 'text-xs font-medium text-zinc-900 dark:text-zinc-100' as const;
export const assetSymbolText = 'text-xs font-medium text-zinc-900 dark:text-zinc-100' as const;
...
export const timeSpentRow = 'flex items-center gap-x-1 text-zinc-400 dark:text-zinc-500' as const;
export const timeSpentText = 'text-xs' as const;

// ─── Pagination ────────────────────────────────────────────────
export const paginationWrapper = 'mt-8 flex items-center justify-center' as const;

// ─── Filter Transition (shared props) ──────────────────────────
export const transitionEnter = 'transform transition ease-in-out duration-500 sm:duration-700' as const;
export const transitionLeave = 'transform transition ease-in-out duration-500 sm:duration-700' as const;
export const dropdownLeave = 'transition ease-in duration-100' as const;

// ─── Relative wrapper ──────────────────────────────────────────
export const relativeWrapper = 'relative' as const;
