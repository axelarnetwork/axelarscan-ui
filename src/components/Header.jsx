...
const navigations = [
  ...
  },
  {
    ...
    children: toArray([
      ...
      ['devnet-amplifier', 'devnet-verifiers', 'stagenet'].includes(ENVIRONMENT) && { title: 'Verifiers', href: '/verifiers' },
      ['devnet-amplifier', 'devnet-verifiers', 'stagenet'].includes(ENVIRONMENT) && { title: 'Amplifier Rewards', href: '/amplifier-rewards' },
