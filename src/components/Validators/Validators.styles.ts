...
export const stakeLink =
  'text-sm font-semibold text-blue-600 dark:text-blue-500' as const;

// ─── Status Navigation ──────────────────────────────────────────
export const nav = 'flex gap-x-4' as const;
export const navLinkActive =
  'rounded-md px-3 py-2 text-base font-medium capitalize bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300' as const;
export const navLinkInactive =
  'rounded-md px-3 py-2 text-base font-medium capitalize text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-400' as const;
...
export const thIndexClickable =
  'cursor-pointer py-3.5 pl-4 pr-3 text-left sm:pl-0' as const;
export const thDefault = 'cursor-pointer px-3 py-3.5 text-left' as const;
export const thWhitespace =
  'cursor-pointer whitespace-nowrap px-3 py-3.5 text-left' as const;
export const thUptimeHidden =
  'hidden cursor-pointer px-3 py-3.5 text-left sm:table-cell' as const;
export const thEvmSupported =
...
export const tdUptimeHidden =
  'hidden px-3 py-4 text-left sm:table-cell' as const;
export const tdEvmSupported =
  'table-cell py-4 pl-3 pr-4 text-left sm:pr-0' as const;

// ─── Validator Info Column ──────────────────────────────────────
export const validatorInfoCol = 'flex flex-col gap-y-0.5' as const;
export const operatorAddress =
  'font-medium text-zinc-400 dark:text-zinc-500' as const;
export const numberMuted =
  'font-medium text-zinc-400 dark:text-zinc-500' as const;
