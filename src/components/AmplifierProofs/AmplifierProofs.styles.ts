...
export const proofsHeaderRow = 'flex items-center justify-between gap-x-4' as const;
export const proofsHeaderLeft = 'sm:flex-auto' as const;
export const proofsNavLinks = 'flex items-center space-x-2' as const;
export const evmBatchesLink = 'text-base font-medium leading-6 text-blue-600 dark:text-blue-500' as const;
export const navDivider = 'text-zinc-400 dark:text-zinc-500' as const;
export const proofsTitle = 'text-base font-semibold leading-6 text-zinc-900 underline dark:text-zinc-100' as const;
export const proofsSubtitle = 'mt-2 text-sm text-zinc-400 dark:text-zinc-500' as const;
...
export const thSessionId = 'whitespace-nowrap py-3.5 pl-4 pr-3 text-left sm:pl-0' as const;
...
export const tdTime = 'flex items-center justify-end py-4 pl-3 pr-4 text-right sm:pr-0' as const;
...
// ─── Links ─────────────────────────────────────────────────────
export const linkBlue = 'font-semibold text-blue-600 dark:text-blue-500' as const;
...
// ─── Sign Options ──────────────────────────────────────────────
export const signOptionBase = 'mr-2 rounded-xl px-2.5 py-1 text-xs uppercase' as const;
export const signOptionSigned = 'bg-green-600 text-white dark:bg-green-500' as const;
export const signOptionOther = 'bg-zinc-100 text-zinc-400 dark:bg-zinc-800 dark:text-zinc-500' as const;
