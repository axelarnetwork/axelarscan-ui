...
export const thTxCount = 'whitespace-nowrap px-3 py-3.5 text-right' as const;
...
export const heightWrapper = 'flex flex-col gap-y-0.5' as const;
export const heightLink = 'font-semibold text-blue-600 dark:text-blue-500' as const;
export const tdMiddle = 'px-3 py-4 text-left' as const;
export const hashLink = 'font-medium text-blue-600 dark:text-blue-500' as const;
export const tdTxCount = 'px-3 py-4 text-right' as const;
export const txCountValue = 'font-medium text-zinc-700 dark:text-zinc-300' as const;
