...
export const messageIdLink = 'font-semibold text-blue-600 dark:text-blue-500' as const;
...
export const signOptionUnsubmitted = 'bg-zinc-100 text-zinc-400 dark:bg-zinc-800 dark:text-zinc-500' as const;

// Signs table styles
export const tableWrapper = '-mx-4 mt-8 overflow-x-auto sm:-mx-0 lg:overflow-x-visible' as const;
...
export const thMiddleNowrap = 'whitespace-nowrap px-3 py-3.5 text-left' as const;
...
export const signerLink = 'font-medium text-blue-600 dark:text-blue-500' as const;
export const txHashWrapper = 'flex flex-col gap-y-1' as const;
export const txHashLink = 'font-medium text-blue-600 dark:text-blue-500' as const;
