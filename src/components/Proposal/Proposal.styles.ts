...
export const ddValueBold =
  'mt-1 text-sm font-medium leading-6 text-zinc-700 dark:text-zinc-300 sm:col-span-2 sm:mt-0' as const;
export const descriptionText =
  'linkify max-w-xl whitespace-pre-wrap break-words text-zinc-400 dark:text-zinc-500' as const;
export const infoCodeBlock =
  'rounded-lg bg-zinc-100 p-3 dark:bg-zinc-800' as const;
export const changeTag =
  'w-fit whitespace-nowrap bg-orange-400 dark:bg-orange-500' as const;
export const gmpLink = 'flex h-6 items-center gap-x-3' as const;
export const gmpDivider =
  'h-1 w-12 border-t-2 border-dashed border-zinc-400 dark:border-zinc-600' as const;
export const gmpChainList = 'flex max-w-fit flex-wrap items-center' as const;
export const gmpChainItem = 'mb-0.5 mr-0.5' as const;
export const depositList = 'flex flex-col gap-y-1' as const;
export const depositValue =
  'font-medium text-zinc-700 dark:text-zinc-300' as const;
export const tallyValue =
  'font-medium capitalize text-zinc-400 dark:text-zinc-500' as const;
...
export const votesThRight = 'whitespace-nowrap px-3 py-3.5 text-right' as const;
...
export const votesTdLast = 'py-4 pl-3 pr-4 text-right sm:pr-0' as const;
export const voterLink =
  'font-medium text-blue-600 dark:text-blue-500' as const;
export const votePowerWrapper = 'flex flex-col items-end gap-y-1' as const;
export const votePowerValue =
  'font-semibold text-zinc-900 dark:text-zinc-100' as const;
export const votePowerPercent = 'text-zinc-400 dark:text-zinc-500' as const;
export const voteOptionWrapper = 'flex flex-col items-end' as const;

// Main layout
export const mainLayout = 'flex max-w-4xl flex-col gap-y-4 sm:gap-y-6' as const;
