...
export const stepCircleBase =
  'relative flex h-8 w-8 items-center justify-center rounded-full' as const;
export const stepCircleFailed =
  'bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-400' as const;
export const stepCircleSuccess =
  'bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-400' as const;
...
export const stepLabelBase =
  'absolute mt-1 whitespace-nowrap text-2xs font-medium' as const;
...
export const stepPendingBar =
  'h-0.5 w-full bg-zinc-200 dark:bg-zinc-700' as const;
export const stepPendingCircleBase =
  'relative flex h-8 w-8 items-center justify-center rounded-full border-2 bg-zinc-50 dark:bg-zinc-800' as const;
export const stepPendingBorderInactive =
  'border-zinc-200 dark:border-zinc-700' as const;
export const stepPendingBorderActive =
  'border-blue-600 dark:border-blue-500' as const;
export const stepPendingClockActive =
  'text-blue-600 dark:text-blue-500' as const;
export const stepPendingClockInactive =
  'text-zinc-200 dark:text-zinc-700' as const;
export const stepPendingLabelBase =
  'absolute mt-12 whitespace-nowrap pt-1 text-2xs font-medium' as const;
export const stepPendingLabelActive =
  'text-blue-600 dark:text-blue-500' as const;
export const stepPendingLabelInactive =
  'text-zinc-400 dark:text-zinc-500' as const;
...
// ─── Details Table ─────────────────────────────────────────────
export const detailsTableWrapper =
...
export const detailsThead =
  'sticky top-0 z-10 bg-white dark:bg-zinc-900' as const;
export const detailsTheadTr =
...
export const detailsTxLink =
  'font-medium text-blue-600 dark:text-blue-500' as const;
export const detailsMoreInfos = 'flex items-center gap-x-3' as const;
export const detailsBatchLink =
  'text-xs text-blue-600 underline dark:text-blue-500' as const;
export const detailsAckLink =
  'text-xs text-blue-600 underline dark:text-blue-500' as const;
export const detailsIbcFailedLink =
  'whitespace-nowrap text-xs text-red-600 underline dark:text-red-500' as const;
export const detailsIbcSendLink =
  'whitespace-nowrap text-xs text-blue-600 underline dark:text-blue-500' as const;
