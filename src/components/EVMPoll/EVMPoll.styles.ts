...
export const infoPanelSubtitle = 'mt-1 max-w-2xl text-sm leading-6 text-zinc-400 dark:text-zinc-500' as const;
export const txIdRow = 'flex items-center gap-x-1' as const;
export const txIdLink = 'font-semibold text-blue-600 dark:text-blue-500' as const;
...
export const accountLink = 'font-medium text-blue-600 dark:text-blue-500' as const;
...
export const thMiddleRight = 'whitespace-nowrap px-3 py-3.5 text-right' as const;
...
export const votingPowerValue = 'font-semibold text-zinc-900 dark:text-zinc-100' as const;
