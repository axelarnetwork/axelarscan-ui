...
export const summaryStyles = {
  container: 'border-b border-b-zinc-200 dark:border-b-zinc-700 lg:border-t lg:border-t-zinc-200 lg:dark:border-t-zinc-700',
  ...
  stat: {
    ...
    value: {
      ...
      number: '!text-3xl font-medium leading-10 tracking-tight text-zinc-900 dark:text-zinc-100',
    },
    breakdown: {
