...
// Combobox filter styles
export const comboboxButton = 'relative w-full cursor-pointer rounded-md border border-zinc-200 py-1.5 pl-3 pr-10 text-left text-zinc-900 shadow-sm sm:text-sm sm:leading-6' as const;
export const comboboxMultiWrapBase = 'flex flex-wrap' as const;
export const comboboxMultiWrapSelected = 'my-1' as const;
export const comboboxTag = 'my-1 mr-2 flex h-6 min-w-fit items-center rounded-xl bg-zinc-100 px-2.5 py-1 text-zinc-900' as const;
export const comboboxSearchWrapper = 'mt-2 gap-y-2' as const;
