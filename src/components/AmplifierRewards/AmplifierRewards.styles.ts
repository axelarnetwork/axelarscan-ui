...
export const listboxCheckWrapper =
...
export const contractsTheadRow =
  'text-base font-semibold text-zinc-800 dark:text-zinc-200' as const;
export const contractsTh = 'px-4 py-6 text-left sm:px-6' as const;
export const contractsTbody =
  'divide-y divide-zinc-100 dark:divide-zinc-800' as const;
export const contractsTr =
...
export const poolTag =
  'w-fit bg-green-600 capitalize text-white dark:bg-green-500' as const;
export const recipientsWrapper = 'flex flex-col gap-y-2' as const;
export const recipientToggle =
  'flex cursor-pointer items-center gap-x-1' as const;
export const recipientCount =
  'font-medium text-zinc-900 dark:text-zinc-100' as const;
export const recipientGrid =
  'grid grid-cols-2 gap-x-8 gap-y-4 lg:grid-cols-3' as const;
export const recipientRow =
  'flex items-center justify-between gap-x-2' as const;
export const recipientProfileClass = 'text-xs' as const;
export const recipientAmount =
