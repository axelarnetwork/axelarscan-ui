...
export const thHiddenWrap =
  'hidden whitespace-nowrap px-3 py-3.5 text-left sm:table-cell' as const;
export const thHiddenRight =
  'hidden px-3 py-3.5 text-right sm:table-cell' as const;
...
export const tdHiddenRight =
  'hidden px-3 py-4 text-right sm:table-cell' as const;
...
export const proposalTitle =
  'max-w-xs whitespace-pre-wrap break-words font-display font-semibold text-blue-600 dark:text-blue-500 sm:max-w-sm' as const;
export const proposalDescription =
  'max-w-xs whitespace-pre-wrap break-words text-zinc-400 dark:text-zinc-500 sm:max-w-sm' as const;
...
export const votingPeriodTime =
  'whitespace-nowrap text-xs font-medium text-zinc-700 dark:text-zinc-300' as const;
...
export function getStatusColor(status: string): string {
  ...
  if (['VOTING_PERIOD'].includes(status))
