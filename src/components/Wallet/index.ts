...
export { useCosmosWalletStore, useConnect, useSyncState } from './CosmosWallet.hooks';
...
export { StellarWallet, useStellarWalletStore, STELLAR_NETWORK_PASSPHRASES } from './StellarWallet.component';
