...
export const keyIdLabel =
  'text-sm font-normal leading-6 text-zinc-400 dark:text-zinc-500' as const;
export const prevBatchWrapper = 'mt-3 max-w-2xl' as const;
export const prevBatchLink =
  'flex items-center gap-x-1 font-medium text-blue-600 dark:text-blue-500' as const;
...
export const dlRow =
  'px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6' as const;
export const dtLabel =
  'text-sm font-medium text-zinc-900 dark:text-zinc-100' as const;
export const ddValue =
  'mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300 sm:col-span-3 sm:mt-0' as const;

// Status
export const statusWrapper = 'flex items-center space-x-3' as const;
export const statusTagExecuted =
  'w-fit capitalize bg-green-600 dark:bg-green-500' as const;
export const statusTagSigned =
  'w-fit capitalize bg-orange-500 dark:bg-orange-600' as const;
export const statusTagSigning =
  'w-fit capitalize bg-yellow-400 dark:bg-yellow-500' as const;
export const statusTagDefault =
...
export const commandTagExecuted =
  'w-fit text-2xs capitalize bg-green-600 dark:bg-green-500' as const;
export const commandTagUnexecuted =
  'w-fit text-2xs capitalize bg-orange-500 dark:bg-orange-600' as const;
...
export const assetBadge =
  'mr-2 flex h-6 min-w-fit items-center gap-x-1.5 rounded-xl bg-zinc-100 px-2.5 py-1 dark:bg-zinc-800' as const;
export const assetText =
  'text-xs font-medium text-zinc-900 dark:text-zinc-100' as const;
export const sourceChainWrapper =
  'mr-2 flex h-6 min-w-fit items-center gap-x-1.5' as const;
export const tooltipNoWrap = 'whitespace-nowrap' as const;
export const codeIcon = 'text-zinc-700 dark:text-zinc-300' as const;
export const mintTransferWrapper =
  'mr-2 flex h-6 min-w-fit items-center gap-x-1.5' as const;
...
export const ownersBadge =
  'mr-2 h-6 rounded-xl bg-zinc-100 px-2.5 py-1 text-xs font-medium text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300' as const;
export const operatorsWrapper = 'mr-2 flex items-center' as const;
export const operatorsBadge =
  'mr-2 h-6 rounded-xl bg-zinc-100 px-2.5 py-1 text-xs font-medium text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300' as const;
...
export const dataTag =
  'break-all bg-white px-3 py-3 font-sans text-zinc-500 dark:bg-zinc-800 dark:text-zinc-500' as const;
export const dataCopy = 'mt-3' as const;
export const signaturesGrid =
  'grid grid-cols-2 gap-1 sm:grid-cols-3 lg:grid-cols-4' as const;
...
export const executeButtonBase =
  'flex h-6 items-center whitespace-nowrap rounded-xl px-2.5 py-1 font-display text-white' as const;
export const executeButtonDisabled =
  'pointer-events-none bg-blue-400 dark:bg-blue-400' as const;
export const executeButtonEnabled =
  'bg-blue-600 hover:bg-blue-500 dark:bg-blue-500 dark:hover:bg-blue-600' as const;

// Toast
export const toastWrapper =
  'flex flex-col gap-y-1 rounded-lg bg-white px-3 py-2.5 shadow-lg sm:gap-y-0' as const;
export const toastRow = 'flex items-center gap-x-1.5 sm:gap-x-2' as const;
export const toastMessage = 'text-zinc-700' as const;
export const toastLinkRow =
  'ml-6 flex items-center justify-between gap-x-4 pl-0.5 sm:ml-7 sm:pl-0' as const;
export const toastExplorerLink = 'text-zinc-700 text-xs sm:text-sm' as const;
export const toastDismiss =
  'text-xs font-light text-zinc-400 underline sm:text-sm' as const;
