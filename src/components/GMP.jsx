  ...
  return (
    <div className="bg-zinc-100 dark:bg-zinc-800">
      <dl className="divide-y divide-zinc-100 dark:divide-zinc-800">
        <div className="grid gap-2 px-4 py-6 sm:px-6">
                      ...
                      ['express_executed', 'executed'].includes(status) && (
                        <div className="flex items-center gap-x-1 text-green-600 dark:text-green-500">
                          ...
                          <TimeSpent
                            fromTimestamp={0}
                            toTimestamp={
                              time_spent.call_express_executed * 1000
                            }
                          />
                        </div>
                      )}
          ...
          <div className="grid gap-2 px-4 py-6 sm:px-6">
            ...
            <dd className="mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
              <Copy
                ...
                className="!min-w-4"
              >
                <span className="break-all text-xs">{messageId}</span>
              </Copy>
            </dd>
          </div>
        )}
          ...
          <div className="grid gap-2 px-4 py-6 sm:px-6">
            ...
            <dd className="mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
              <Copy
                ...
                className="!min-w-4"
              >
                <span className="break-all text-xs">{commandId}</span>
              </Copy>
            </dd>
          </div>
        )}
          ...
          <div className="grid gap-2 px-4 py-6 sm:px-6">
            ...
            <dd className="mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
              <Copy
                ...
                className="!min-w-4"
              >
                <span className="break-all text-xs">{sourceAddress}</span>
              </Copy>
            </dd>
          </div>
        )}
          ...
          <div className="grid gap-2 px-4 py-6 sm:px-6">
            ...
            <dd className="mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
              <Copy
                ...
                className="!min-w-4"
              >
                <span className="break-all text-xs">{payloadHash}</span>
              </Copy>
            </dd>
          </div>
        )}
        ...
        <dl className="divide-y divide-zinc-100 dark:divide-zinc-800">
          <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300 sm:col-span-3 sm:mt-0">
              <Tag className={clsx('w-fit capitalize')}>{getEvent(data)}</Tag>
            </dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6">
            <dt className="text-sm font-medium text-zinc-900 dark:text-zinc-100">
                      ...
                      <div key={i} className="flex flex-col gap-y-1.5">
                        ...
                        <nav
                          ...
                          className={clsx(
                            'overflow-x-auto',
                            (isAxelar(sourceChain) &&
                              toArray(d.executed?.childMessageIDs).length >
                                0) ||
                              (isAxelar(destinationChain) &&
                            ...
                            {steps.map((d, i) => {
                              ...
                              if (url && transaction_path) {
                                switch (d.id) {
                                  case 'pay_gas':
                                    if (
                                      transactionHash ||
                                      data.originData?.call?.transactionHash
                                    ) {
                              ...
                              const element = (
                                <>
                                    ...
                                    parentMessageID && (
                                      <div className="absolute mt-6">
                                        <Link
                                          ...
                                          target="_blank"
                                          className="whitespace-nowrap rounded-md border border-blue-600 px-2 py-1.5 text-base font-semibold text-blue-600 dark:border-blue-500 dark:text-blue-500"
                                        >
                                          ← prev Hop
                                        </Link>
                                      </div>
                                  ...
                                  {!isAxelar(destinationChain) &&
                                    toArray(childMessageIDs).map(id => (
                        ...
                        {d.is_insufficient_fee &&
                          ...
                          ((!isAxelar(d.call.chain) &&
                            ...
                            timeDiff(d.call.created_at?.ms) > 120) && (
          ...
          {((settlement_forwarded_events && executed) ||
            (settlement_filled_events && data.settlementForwardedData)) && (
            <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-zinc-900 dark:text-zinc-100">
                Settlement Status
              </dt>
              <dd className="mt-4 text-sm leading-6 text-zinc-700 dark:text-zinc-300 sm:col-span-3 sm:mt-1.5">
                <div className="flex flex-col gap-y-6 overflow-x-auto sm:grid sm:grid-cols-4 sm:gap-x-4 sm:gap-y-0">
                  <div className="flex justify-between gap-x-4">
                    <div className="flex flex-col gap-y-2 sm:gap-y-4">
                      <span className="whitespace-nowrap text-2xs font-medium text-blue-600 dark:text-blue-500">
                  ...
                  {executedGMPsData.length > 0 && (
                    <div className="flex items-center gap-x-1 text-zinc-400 dark:text-zinc-500">
                      ...
                      <TimeSpent
                        fromTimestamp={0}
                        toTimestamp={
                          _.sumBy(executedGMPsData, 'time_spent.total') * 1000
                        }
                      />
                    </div>
                  )}
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300 sm:col-span-3 sm:mt-0">
                <div className="flex flex-col gap-y-2">
                  <Profile
                    address={
                      data.originData?.call?.returnValues?.sender ||
                      sourceAddress
                    }
                    chain={data.originData?.call?.chain || sourceChain}
                  />
          ...
          {(!data.originData || data.originData.executed) &&
            ...
            (refundedData?.receipt?.status ||
              timeDiff(
                (data.originData?.executed || executed).block_timestamp * 1000
              ) >= 300) && (
              <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6">
                <dt className="flex items-center text-sm font-medium text-zinc-900 dark:text-zinc-100">
                ...
                <dd className="mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300 sm:col-span-3 sm:mt-0">
                  <div className="flex items-center gap-x-2">
                    <Number
                      value={
                        gasData.gas_paid_amount -
                        (refundedData?.receipt?.status
                          ? isNumber(refundedData.amount)
                            ? refundedData.amount
                            : gasData.gas_remain_amount
                          : 0) -
                        _.sum(refundedMoreData.map(d => toNumber(d.amount)))
                      }
                      format="0,0.000000"
                        ...
                        value={
                          (gasData.gas_paid_amount -
                            (refundedData?.receipt?.status
                              ...
                              : 0) -
                            _.sum(
                              refundedMoreData.map(d => toNumber(d.amount))
                            )) *
          ...
          {!lite && seeMore && (
            <>
                          ...
                          {fees.source_confirm_fee > 0 && (
                            <>
                              ...
                              <div className="ml-3 flex items-center gap-x-1">
                                ...
                                <Number
                                  value={
                                    fees.base_fee - fees.source_confirm_fee > 0
                                  ...
                                  <Number
                                    value={
                                      ...
                                      0
                                        ? fees.base_fee -
                                          fees.source_confirm_fee
                                        : 0) * fees.source_token.token_price.usd
                                    }
                                    prefix="($"
                                    suffix=")"
                                    noTooltip={true}
              ...
              <div
                className={clsx(
                  'grid gap-4 py-4',
                  data.callbackData && 'md:grid-cols-2'
                )}
              >
                  ...
                  default:
                    if (proposal_id) {
                      ...
                      if (
                        ...
                        (d.id === 'refund' && data.refunded_more_transactions)
                      ) {
                        for (const { transactionHash } of toArray(
                          d.id === 'pay_gas'
                            ? isString(d.data)
                              ? data.originData.gas_added_transactions
                              : data.gas_added_transactions
                ...
                switch (d.id) {
                  ...
                  case 'refund':
                    gasAmount =
                      refunded?.amount +
                      _.sum(
                        toArray(data.refunded_more_transactions).map(d =>
                          toNumber(d.amount)
                        )
                      );
                    break;
            ...
            buttons={Object.fromEntries(
              Object.entries({
                ...
                sourceChainData?.chain_type !== 'cosmos'
                  ? 'confirm'
                  : sourceChainData?.chain_type === 'cosmos' && !executeButton
                    ? 'execute'
                  ...
                  data={{
                    ...
                    callbackData: Object.fromEntries(
                      Object.entries(data).filter(
                        ([k, v]) => !find(k, ['originData', 'callbackData'])
                      )
                    ),
                  }}
                />
