...
export const filterSearchInput = (string, pattern) => !pattern || (pattern.length > 2 ? includesSomePatterns(string, pattern) : toCase(string, 'lower').startsWith(toCase(pattern, 'lower'))) 
